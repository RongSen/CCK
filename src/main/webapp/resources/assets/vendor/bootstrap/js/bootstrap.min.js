...
+function($) {
	...
	Alert.prototype.close = function(e) {
		...
		$.support.transition && $parent.hasClass('fade') ? $parent.one(
				'bsTransitionEnd', removeElement).emulateTransitionEnd(150)
				: removeElement()
	}
...
+function($) {
	...
	Modal.prototype.backdrop = function(callback) {
		...
		// 获取模态框对象的z-index
		var zIndex = Number(this.$element.css('z-index')) - 1;
...
+function($) {
		...
		if (this.hasContent() && this.enabled) {
			...
			if (autoPlace) {
				...
				placement = placement == 'bottom'
						...
						: placement == 'top'
								&& pos.top - parentDim.scroll - actualHeight < 0 ? 'bottom'
								: placement == 'right'
										&& pos.right + actualWidth > parentDim.width ? 'left'
										: placement == 'left'
												&& pos.left - actualWidth < parentDim.left ? 'right'
												: placement
			...
			$.support.transition && this.$tip.hasClass('fade') ? $tip.one(
					'bsTransitionEnd', complete).emulateTransitionEnd(150)
					: complete()
		}
	}
	...
	Tooltip.prototype.applyPlacement = function(offset, placement) {
		...
		var arrowDelta = delta.left ? delta.left * 2 - width + actualWidth
...
+function($) {
	...
	Tab.prototype.activate = function(element, container, callback) {
		...
		transition ? $active.one('bsTransitionEnd', next).emulateTransitionEnd(
				150) : next()
